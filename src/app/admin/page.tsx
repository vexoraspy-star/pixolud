...
import { CHEAT_GAMES, enabledCheatGames, requireAdmin } from "@/lib/admin";
...
async function loadAdminData(me: { id: string; pseudo: string }): Promise<AdminData> {
  ...
  const data: AdminData = {
    ...
    migrationReady: !logRes.error && (profiles.length === 0 || "verified" in profiles[0]),
