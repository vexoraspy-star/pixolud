...
const AUDIO_TRACKS: AudioTrack[] = [
  ...
  {
    kind: "audio",
    id: "chopin-nocturne-cdiese",
    title: "Nocturne en ut dièse mineur",
    composer: "Frédéric Chopin",
    category: "Piano",
    emoji: "🌙",
    ...
    license: "Domaine public (CC0)",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Chopin,_Nocturne_in_C-sharp_minor,_Op._Posth.ogg",
  },
  {
    kind: "audio",
    ...
    category: "Orchestral",
    emoji: "🍂",
    src: "https://upload.wikimedia.org/wikipedia/commons/0/07/Elman_74341_NR.ogg",
    license: "Domaine public",
    attribution: "Mischa Elman (violon), Josef Bonime (piano)",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Elman_74341_NR.ogg",
  },
  {
    kind: "audio",
    id: "debussy-reverie",
    ...
    category: "Piano",
    emoji: "💭",
    src: "https://upload.wikimedia.org/wikipedia/commons/5/53/Reverie.ogg",
    license: "Domaine public",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Reverie.ogg",
  },
  {
    kind: "audio",
    ...
    category: "Orchestral",
    emoji: "🦢",
    src: "https://upload.wikimedia.org/wikipedia/commons/8/82/Tchaikovsky_-_Swan_Lake_Op.20_-_Act_II_Pt.1.ogg",
    license: "Domaine public",
    sourceUrl:
  ...
  },
  {
    kind: "audio",
    id: "gabber-full-one",
    title: "The Full Gabber One",
    composer: "Saboum-PSYYPS",
    category: "Hardtek",
    emoji: "💥",
    src: "https://prod-1.storage.jamendo.com/download/track/572737/mp32/",
    license: "CC BY-SA",
    attribution: "Saboum-PSYYPS (Jamendo)",
    sourceUrl: "https://www.jamendo.com/track/572737",
  },
  {
    kind: "audio",
    id: "gabber-storm-master",
    title: "Storm-Master",
    composer: "Saboum-PSYYPS",
    category: "Hardtek",
    emoji: "🌩️",
    src: "https://prod-1.storage.jamendo.com/download/track/572771/mp32/",
    license: "CC BY-SA",
    attribution: "Saboum-PSYYPS (Jamendo)",
    sourceUrl: "https://www.jamendo.com/track/572771",
  },
  {
    kind: "audio",
    id: "hardstyle-face",
    title: "Hardstyle Face",
    composer: "Dj Rocchino",
    category: "Hardtek",
    emoji: "👹",
    src: "https://prod-1.storage.jamendo.com/download/track/373926/mp32/",
    license: "CC BY-SA",
    attribution: "Dj Rocchino (Jamendo)",
    sourceUrl: "https://www.jamendo.com/track/373926",
  },
];
