...
const links = [["/catalogue", "nav.catalogue"], ["/mode-3d", "nav.mode3d"], ["/multijoueur", "nav.multiplayer"], ["/pixocall", "nav.pixocall"], ["/editeur", "nav.createGame"], ["/a-propos", "nav.about"], ["/premium", "nav.premium"]];
